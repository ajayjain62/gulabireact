...
const ThreeJsCarousel = () => {
  ...
  const categories = [
    ...
    {
      src: "src/assets/img/category/palmetto.jpg",
      label: "Saw Palmetto",
      link: "/category/body-detox",
    },
    {
      src: "src/assets/img/products/RESVERATROL4.jpg",
      label: "Reservatrol Extracts",
      link: "/category/collagen-supplement",
    },
    {
      src: "src/assets/img/products/6f9ae439beaa6cc721d276d6f6089820.jpg",
      label: "Grape Seed",
