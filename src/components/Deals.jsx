...
export default function Component() {
  return (
    <>
      <section
        className="driven-by-purpose-section"
        style={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div
                className="driven-by-purpose-bg-image"
                style={{
                  boxSizing: "border-box",
                  outline: "none",
                  width: "80%",
              ...
              >
                <div
                  className="driven-by-purpose-icon"
                  style={{
                    boxSizing: "border-box",
                    outline: "none",
                    margin: "0px 0px 15px",
                ...
                >
                  <img
                    ...
                    src="https://www.cipla.com/themes/cipla/images/icon-glass.svg"
                    style={{
                      boxSizing: "border-box",
                      outline: "none",
                      borderStyle: "none",
