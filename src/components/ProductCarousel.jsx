  ...
  return (
    <>
      ...
      >
          ...
          >
            ...
            >
              ...
              >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Growing operations in 50+ Countries{" "}
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <ul
                  className="absolute w-full !flex items-center justify-end gap-[2px] md:gap-2 bottom-[20px] md:bottom-[66px] right-[10%]"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
                    listStyle: "none",
                ...
                >
                  ...
                  >
                    <div
                      className="min-h-1 md:min-h-2 min-w-1 md:min-w-2 rounded-[50%] bg-[#FFFFFF6B] transition-all duration-300 cursor-pointer"
                      style={{
                        border: "0px solid rgb(229, 231, 235)",
                        boxSizing: "border-box",
                        cursor: "pointer",
                  ...
                  >
                    <div
                      className="min-h-[7px] md:min-h-[14px] min-w-4 md:min-w-8 rounded-[18px] md:rounded-[36px] bg-white transition-all duration-300 cursor-pointer"
                      style={{
                        border: "0px solid rgb(229, 231, 235)",
                        boxSizing: "border-box",
                        cursor: "pointer",
        ...
        <section
          className="pt-12 pb-12 xl:pt-20 xl:pb-16 px-4 container mx-auto"
          style={{
            border: "0px solid rgb(229, 231, 235)",
            boxSizing: "border-box",
            width: "100%",
        ...
        >
          <div
            className="flex 2xl:flex-row items-center justify-center gap-y-8 flex-wrap xl:flex-nowrap -mx-4"
            style={{
              border: "0px solid rgb(229, 231, 235)",
              boxSizing: "border-box",
              marginLeft: "-1rem",
          ...
          >
            <div
              className="w-full xl:w-[50%] 2xl:w-[55%] px-4"
              style={{
                border: "0px solid rgb(229, 231, 235)",
                boxSizing: "border-box",
                paddingLeft: "1rem",
            ...
            >
              ...
              >
                <p
                  className="text-[32px] font-bold leading-normal lg:text-[42px] xl:text-[52px] 2xl:text-[62px] text-[#363678]"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
                    margin: "0px",
                ...
                <a
                  className="h-8 w-8 min-w-8 bg-[#36367824] rounded-[50%] border-none flex items-center justify-center"
                  href="https://www.torrentpharma.com/ourstory/overview/"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
              ...
              <p
                className="text-sm 2xl:text-lg 2xl:leading-8 text-[#717170] mt-2 md:mt-4"
                style={{
                  border: "0px solid rgb(229, 231, 235)",
                  boxSizing: "border-box",
                  margin: "0px",
...
Torrent Pharma has crossed many geographical boundaries with presence in more than 50 countries. The Company is ranked first amongst Indian Companies for having largest market share in Brazil and Germany.`}</p>
            ...
            >
              ...
              >
                <div
                  className="flex flex-col md:flex-row md:border-b-[1px] md:border-[#C9C9C9B2] relative"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
                    position: "relative",
                    ...
                    borderColor: "rgba(201, 201, 201, 0.698)",
                    fontFamily: "Lato, sans-serif",
                  }}
                >
                  <div
                    className="md:block hidden w-[6px] h-[6px] absolute bg-[#C9C9C9B2] rotate-45 overview_right_border_dot left_dot"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      position: "absolute",
                      ...
                      backgroundColor: "rgba(201, 201, 201, 0.698)",
                      letterSpacing: "0.02em",
                      display: "block",
                      bottom: "calc(0% - 3.5px)",
                      zIndex: 99999999,
                  ...
                  />
                  <div
                    className="md:block hidden w-[6px] h-[6px] absolute bg-[#C9C9C9B2] rotate-45 overview_right_border_dot right_dot"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      position: "absolute",
                  ...
                  />
                  <div
                    className="md:block hidden w-[6px] h-[6px] absolute bg-[#C9C9C9B2] rotate-45 overview_right_border_dot top_dot"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      position: "absolute",
                  ...
                  />
                  <div
                    className="flex flex-col items-start md:items-end pt-[42px] md:pt-7 ml-10 md:ml-0 md:border-r-[1px] md:border-[#C9C9C9B2] pl-[25px] md:pl-0 md:pr-[25px] pb-[42px] md:w-1/2"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      display: "flex",
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className="flex items-center gap-x-2 mt-[14px]"
                        style={{
                          border: "0px solid rgb(229, 231, 235)",
                          boxSizing: "border-box",
                          marginTop: "14px",
                      ...
                      >
                        <img
                          ...
                          alt="ManufacturingPlants"
                          src="https://www.torrentpharma.com/assets/Manufacturing_Plants_7a3cf99780.png"
                          style={{
                            border: "0px solid rgb(229, 231, 235)",
                            boxSizing: "border-box",
                            display: "block",
                        ...
                        />
                        <span
                          className="overview_rspan_text text-[18px] text-[#717170] font-normal md:text-[18px]"
                          style={{
                            border: "0px solid rgb(229, 231, 235)",
                            boxSizing: "border-box",
                            fontWeight: 400,
                  ...
                  <img
                    ...
                    height={6}
                    width={366}
                    alt="horizontal_divider"
                    src="https://www.torrentpharma.com/_next/static/media/horizontal-divider.4168cb82.svg"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      verticalAlign: "middle",
                  ...
                  />
                  <div
                    className="flex flex-col items-start pt-[42px] md:pt-7 ml-10 md:ml-0 pl-[25px] pb-[42px] md:w-1/2"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      display: "flex",
                    ...
                    >
                      ...
                      >
                        <img
                          className="w-fit h-fit"
                          alt="Scientists"
                          src="https://www.torrentpharma.com/assets/Scientists_5f58d00204.png"
                          style={{
                            border: "0px solid rgb(229, 231, 235)",
                            boxSizing: "border-box",
                            display: "block",
                ...
                >
                  <div
                    className="md:block hidden w-[6px] h-[6px] absolute bg-[#C9C9C9] opacity-70 rotate-45 overview_right_border_dot bottom_dot"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      position: "absolute",
                      ...
                      transform:
                        "translate(0,0) rotate(45deg) skewX(0) skewY(0) scaleX(1) scaleY(1)",
                      backgroundColor: "rgb(201 201 201/1)",
                      opacity: 0.7,
                      letterSpacing: "0.02em",
                      display: "block",
                      bottom: "calc(0% - 3.5px)",
                  ...
                  />
                  <div
                    className="flex flex-col items-start md:items-end ml-10 md:ml-0 md:border-r-[1px] md:border-[#C9C9C9B2] pl-[25px] md:pl-0 md:pr-[25px] pb-[42px] md:pb-7 pt-[42px] md:w-1/2"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      display: "flex",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <img
                          className="w-fit h-fit"
                          alt="ProductRegistrations"
                          src="https://www.torrentpharma.com/assets/Product_Registration_69530a7308.png"
                          style={{
                            border: "0px solid rgb(229, 231, 235)",
                            boxSizing: "border-box",
                            display: "block",
                  ...
                  />
                  <div
                    className="flex flex-col items-start ml-10 md:ml-0 pl-[25px] pt-[42px] pb-[42px] md:pb-7 md:w-1/2"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      display: "flex",
                    ...
                    >
                      ...
                      >
                        <img
                          className="w-fit h-fit"
                          alt="Countries"
                          src="https://www.torrentpharma.com/assets/Countries_f89fcaeb23.png"
                          style={{
                            border: "0px solid rgb(229, 231, 235)",
                            boxSizing: "border-box",
                            display: "block",
        ...
        <section
          className="tp_our_reach_section"
          style={{
            border: "0px solid rgb(229, 231, 235)",
            boxSizing: "border-box",
            letterSpacing: "0.02em",
            background:
              "linear-gradient(129.27deg, rgb(54, 54, 120) 7.77%, rgb(15, 15, 65) 88.92%)",
            fontFamily: "Lato, sans-serif",
          }}
        >
          <div
          ...
          >
            <div
              className="py-[32px] md:py-[81px] mx-auto"
              style={{
                border: "0px solid rgb(229, 231, 235)",
                boxSizing: "border-box",
                marginLeft: "auto",
            ...
            >
              <div
                className="flex 2xl:flex-row items-center justify-between gap-[42px] flex-wrap xl:flex-nowrap"
                style={{
                  border: "0px solid rgb(229, 231, 235)",
                  boxSizing: "border-box",
                  display: "flex",
              ...
              >
                <div
                  className="ourreach_left_content grid gap-[32px] md:gap-[42px] w-full xl:w-[60%]"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
                    display: "grid",
                ...
                >
                  ...
                  >
                    <p
                      className="text-[32px] font-bold leading-normal lg:text-[42px] xl:text-[52px] 2xl:text-[62px] text-white"
                      style={{
                        border: "0px solid rgb(229, 231, 235)",
                        boxSizing: "border-box",
                        margin: "0px",
                    ...
                    <p
                      className="text-base 2xl:text-lg leading-5 md:leading-8 text-white opacity-70 mt-2"
                      style={{
                        border: "0px solid rgb(229, 231, 235)",
                        boxSizing: "border-box",
                        margin: "0px",
                    ...
                    >
                      Marketing Presence in 50+ Countries
                    </p>
                  </div>
                  <img
                    alt="WorldMap"
                ...
                <div
                  className="flex-wrap justify-center hidden xl:flex h-[400px]"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
                    height: "400px",
                ...
                >
                  <img
                    ...
                    width={6}
                    alt="ourreachborder1"
                    src="https://www.torrentpharma.com/_next/static/media/ourreachborder1.0f975447.svg"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      display: "block",
                ...
                <div
                  className="ourreach_right_content flex flex-col justify-between items-center self-stretch xl:w-[40%]"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
                    display: "flex",
                ...
                >
                  <div
                    className="flex flex-col items-start gap-4 md:gap-6 self-stretch"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      display: "flex",
                  ...
                  >
                    <a
                      className="flex items-center justify-start gap-6"
                      href="https://www.torrentpharma.com/business-area/india-business/"
                      style={{
                        border: "0px solid rgb(229, 231, 235)",
                        boxSizing: "border-box",
                        textDecoration: "inherit",
                    ...
                    >
                      <p
                        className="text-lg md:text-2xl font-extrabold md:font-bold text-white leading-[22px] md:leading-[28.8px]"
                        style={{
                          border: "0px solid rgb(229, 231, 235)",
                          boxSizing: "border-box",
                          margin: "0px",
                      ...
                      <div
                        className="h-8 w-8 rounded-[50%] flex items-center justify-center bg-[#FFFFFF1A]"
                        style={{
                          border: "0px solid rgb(229, 231, 235)",
                          boxSizing: "border-box",
                          display: "flex",
                    ...
                    <p
                      className="text-sm 2xl:text-lg leading-8 text-white opacity-70"
                      style={{
                        border: "0px solid rgb(229, 231, 235)",
                        boxSizing: "border-box",
                        margin: "0px",
                  ...
                  >
                    <a
                      className="flex items-center justify-start gap-6"
                      href="https://www.torrentpharma.com/business-area/international-business/"
                      style={{
                        border: "0px solid rgb(229, 231, 235)",
                        boxSizing: "border-box",
                        textDecoration: "inherit",
        ...
        >
          ...
          >
            <div
              className="flex flex-col justify-center items-center self-stretch gap-[60px]"
              style={{
                border: "0px solid rgb(229, 231, 235)",
                boxSizing: "border-box",
                display: "flex",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    className="min-h-8 min-w-8 rounded-[50%] flex items-center justify-center bg-[#36367824] mr-4 md:mr-0"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      display: "flex",
                ...
                <p
                  className="text-[16px] font-normal leading-normal md:leading-8 md:text-[18px] text-[#717170] mt-2"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
                    margin: "0px",
              ...
              <div
                className="our_brands_wrapper flex flex-col md:flex-row flex-wrap items-center justify-center gap-[70px] md:gap-[100px] p-6 3xl:p-[42px] md:max-w-[990px]"
                style={{
                  border: "0px solid rgb(229, 231, 235)",
                  boxSizing: "border-box",
                  display: "flex",
              ...
              >
                <a
                  ...
                  style={{
                    ...
                    borderRadius: "32px",
                    boxShadow:
                      "var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),0px 32px 54.67px 0px rgba(0,0,0,.2)",
                    letterSpacing: "0.02em",
                    minHeight: "212.256px",
                    minWidth: "400px",
                    maxWidth: "400px",
                    backgroundImage:
                      "linear-gradient(225deg, rgb(131, 78, 150), rgb(104, 52, 128))",
                    fontFamily: "Lato, sans-serif",
                  }}
                >
                  <div
                    className="flex flex-col flex-wrap px-5 py-8 sm:p-[34px] justify-between"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      display: "flex",
                ...
                <a
                  ...
                  style={{
                    ...
                    maxWidth: "400px",
                    backgroundImage:
                      "linear-gradient(225deg, rgb(4, 99, 191), rgb(4, 64, 122))",
                    fontFamily: "Lato, sans-serif",
                  }}
                >
                  <div
                  ...
                  <div
                    className="absolute h-full md:h-auto UnienzmesProd transition-all duration-300"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      position: "absolute",
                ...
                <a
                  ...
                  style={{
                    ...
                    maxWidth: "400px",
                    backgroundImage:
                      "linear-gradient(225deg, rgb(28, 115, 144), rgb(21, 86, 107))",
                    fontFamily: "Lato, sans-serif",
                  }}
                >
                  <div
                    className="flex flex-col flex-wrap p-7 md px-5 py-8:sm:p-[34px] justify-between"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      display: "flex",
                  ...
                  <div
                    className="absolute bottom-[5px] right-[-5px] h-full md:h-auto AhaglowProd transition-all duration-300"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      position: "absolute",
...
With leading brands in various therapeutic segments, our products have proved to be efficient and effective in various therapeutic areas.`}</p>
        ...
        <section
          className="tp_env_sustainability_section py-[52px] md:py-[124px]"
          style={{
            border: "0px solid rgb(229, 231, 235)",
            boxSizing: "border-box",
            letterSpacing: "0.02em",
        ...
        >
          ...
          >
            ...
            >
              <div
                className="h-[409px] w-[409px] hidden md:block"
                style={{
                  border: "0px solid rgb(229, 231, 235)",
                  boxSizing: "border-box",
                  height: "409px",
              ...
              <div
                className="env_sustainability_right_content flex flex-col justify-start items-center md:items-start gap-6 2xl:gap-[32px] flex-1 basis-0 grow"
                style={{
                  border: "0px solid rgb(229, 231, 235)",
                  boxSizing: "border-box",
                  display: "flex",
              ...
              >
                ...
                >
                  ...
                  <p
                    className="text-[16px] font-normal leading-6 md:leading-8 md:text-[18px] text-[#717170]"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      margin: "0px",
                ...
                <p
                  className="text-[18px] leading-[30px] md:leading-8 md:text-[18px] text-[#717170]"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
                    margin: "0px",
        ...
        <section
          className="tp_press_releases pt-[60px] pb-[35px]"
          style={{
            border: "0px solid rgb(229, 231, 235)",
            boxSizing: "border-box",
            paddingBottom: "35px",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <a
                    href="https://www.torrentpharma.com/investors/press-release-archives/"
                    style={{
                      border: "0px solid rgb(229, 231, 235)",
                      boxSizing: "border-box",
                      textDecoration: "inherit",
                ...
                <p
                  className="text-[#717170] text-[16px] font-normal leading-8 md:text-[18px] mt-4"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
                    margin: "0px",
              ...
              >
                <div
                  className="slick-slider news-slider slick-initialized"
                  dir="ltr"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    letterSpacing: "0.02em",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <div
                            className="press_releases_slider_cards_wrapper min-h-[270px] md:min-h-[323.2px] rounded-xl gap-2"
                            tabIndex="-1"
                            style={{
                              border: "0px solid rgb(229, 231, 235)",
                              boxSizing: "border-box",
                          ...
                          >
                            <div
                              className="press_releases_card_header"
                              style={{
                                border: "0px solid rgb(229, 231, 235)",
                                boxSizing: "border-box",
                                letterSpacing: "0.02em",
                            ...
                            <div
                              className="press_releases_card_body pt-[30px] pb-[32px] md:pt-[20px] px-[30px] md:pb-[50px] grid gap-[10px]"
                              style={{
                                border: "0px solid rgb(229, 231, 235)",
                                boxSizing: "border-box",
                                display: "grid",
                            ...
                            >
                              ...
                              >
                                Torrent Pharma announces Q2 FY25 Results
                              </p>
                            </div>
                            <div
                              className="press_releases_card_footer px-[30px] md:pt-[20px] md:pr-[30px] md:pb-[50px] md:pl-[30px]"
                              style={{
                                border: "0px solid rgb(229, 231, 235)",
                                boxSizing: "border-box",
                                letterSpacing: "0.02em",
                            ...
                            >
                              <a
                                href="https://www.torrentpharma.com/assets/Torrent_Pharma_Q2_FY_25_Results_Press_Release_1_61b1477238.pdf"
                              ...
                              >
                                <img
                                  ...
                                  width={40}
                                  alt="Next"
                                  src="https://www.torrentpharma.com/_next/static/media/pressreleasecardarrow.54a44a6c.svg"
                                  style={{
                                    border: "0px solid rgb(229, 231, 235)",
                                    boxSizing: "border-box",
                                    verticalAlign: "middle",
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                refutes claims of Shelcal 500 allegedly failing
                                CDSCO quality test
                              </p>
                            </div>
                            <div
                            ...
                            >
                              <a
                                href="https://www.torrentpharma.com/assets/Media_Release_Torrent_Pharmaceuticals_Shelcal_26_09_2024_6158ba6a77.pdf"
                                rel="noopener noreferrer"
                                target="_blank"
                                style={{
                                  border: "0px solid rgb(229, 231, 235)",
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <a
                                href="https://www.torrentpharma.com/assets/Torrent_Pharma_Press_release_Q1_FY_25_f01fd30751.pdf"
                                rel="noopener noreferrer"
                                target="_blank"
                                style={{
                                  border: "0px solid rgb(229, 231, 235)",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Torrent Pharmaceuticals Enters into
                                Non-Exclusive Patent Licensing Agreement with
                                Takeda Pharmaceuticals to Commercialize its
                                Novel Gastrointestinal Drug in India{" "}
                              </p>
                            </div>
                            <div
                              className="press_releases_card_footer px-[30px] md:pt-[20px] md:pr-[30px] md:pb-[50px] md:pl-[30px]"
                            ...
                            >
                              <a
                                href="https://www.torrentpharma.com/assets/TPL_TAK_press_release_vf_d3766b3368.pdf"
                                rel="noopener noreferrer"
                                target="_blank"
                                style={{
                                  border: "0px solid rgb(229, 231, 235)",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Torrent Pharma announces Q4 FY24 Results
                              </p>
                            </div>
                            <div
                              className="press_releases_card_footer px-[30px] md:pt-[20px] md:pr-[30px] md:pb-[50px] md:pl-[30px]"
                            ...
                            >
                              <a
                                href="https://www.torrentpharma.com/assets/Torrent_Pharma_Press_Release_Q4_FY_24_d93eec9ae6.pdf"
                                rel="noopener noreferrer"
                                target="_blank"
                                style={{
                                  border: "0px solid rgb(229, 231, 235)",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Torrent Pharmaceuticals Ltd has reduced the MRP
                                of NLEM product
                              </p>
                            </div>
                            <div
                            ...
                            >
                              <a
                                href="https://www.torrentpharma.com/assets/TPL_NLEM_Price_Revision_55e992349f.pdf"
                                rel="noopener noreferrer"
                                target="_blank"
                                style={{
                                  border: "0px solid rgb(229, 231, 235)",
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <a
                                href="https://www.torrentpharma.com/assets/Torrent_Pharma_Press_Release_Q3_23_24_278b58e40d.pdf"
                                rel="noopener noreferrer"
                                target="_blank"
                                style={{
                                  border: "0px solid rgb(229, 231, 235)",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Torrent and Zydus sign licensing agreement
                              </p>
                            </div>
                            <div
                              className="press_releases_card_footer px-[30px] md:pt-[20px] md:pr-[30px] md:pb-[50px] md:pl-[30px]"
                            ...
                            >
                              <a
                                href="https://www.torrentpharma.com/assets/Press_Release_Torrent_Pharma_10_11_23_5d9ad83ab1.pdf"
                                rel="noopener noreferrer"
                                target="_blank"
                                style={{
                                  border: "0px solid rgb(229, 231, 235)",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Torrent Pharma announces Q2 FY24 Results
                              </p>
                            </div>
                            <div
                              className="press_releases_card_footer px-[30px] md:pt-[20px] md:pr-[30px] md:pb-[50px] md:pl-[30px]"
                            ...
                            >
                              <a
                                href="https://www.torrentpharma.com/assets/Press_Release_Q2_23_24_96d3446454.pdf"
                                rel="noopener noreferrer"
                                target="_blank"
                                style={{
                                  border: "0px solid rgb(229, 231, 235)",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Torrent Pharmaceuticals gets EIR from US FDA for
                                Dahej facility
                              </p>
                            </div>
                            <div
                            ...
                            >
                              <a
                                href="https://www.torrentpharma.com/assets/Torrent_Pharma_Press_Release_24_8_23_4f343066cc.pdf"
                                rel="noopener noreferrer"
                                target="_blank"
                                style={{
                                  border: "0px solid rgb(229, 231, 235)",
                ...
                <div
                  className="flex justify-center md:justify-start gap-8 mt-5"
                  style={{
                    border: "0px solid rgb(229, 231, 235)",
                    boxSizing: "border-box",
                    marginTop: "1.25rem",
                ...
                >
                  ...
                  >
                    <img
                      ...
                      width={42}
                      alt="Previous"
                      src="https://www.torrentpharma.com/_next/static/media/pressreleaseprevbtn.2f61306f.svg"
                      style={{
                        border: "0px solid rgb(229, 231, 235)",
                        boxSizing: "border-box",
                        display: "block",
                  ...
                  >
                    <img
                      ...
                      width={42}
                      alt="Next"
                      src="https://www.torrentpharma.com/_next/static/media/pressreleasenextbtn.d89cf35e.svg"
                      style={{
                        border: "0px solid rgb(229, 231, 235)",
                        boxSizing: "border-box",
                        display: "block",
