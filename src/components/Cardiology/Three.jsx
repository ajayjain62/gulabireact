...
const ThreeJsCarousel = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      label: "Lipoic Acid Tablet",
      link: "/category/antioxidants",
    },
    {
      src: "https://i.postimg.cc/cL8KMbxh/glutathione.jpg",
      label: "Glutathione Tablets 1000mg",
      link: "/category/body-detox",
    },
    {
      src: "https://i.postimg.cc/PJ34ZRXh/glutathione-men.jpg",
      label: "glutathione Men",
      link: "/category/collagen-supplement",
    },
    {
      src: "https://i.postimg.cc/2y7y31DB/L-glutathione.jpg",
      label: "L-Glutathione tablets",
