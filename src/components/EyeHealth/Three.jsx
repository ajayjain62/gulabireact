...
const ThreeJsCarousel = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      label: "Well C Kids Orange",
      link: "/category/anti-diabetic",
    },
    {
      src: "src/assets/img/products/well-c kids.jpg",
      label: "Well C Kids Pineapple",
      link: "/category/antioxidants",
    },
    {
      src: "src/assets/img/products/well-c.jpg",
      label: "Well C Kids Raw Mango",
      link: "/category/body-detox",
    },
    {
      src: "src/assets/img/products/Lutein.jpg",
      label: "Eye Health Lutein",
      link: "/category/collagen-supplement",
    },
    {
      src: "src/assets/img/products/Eye Relief Lutian Vision.jpg",
      label: "Eye Relief Lutian Vision",
