...
AntiAnemic: {
        ...
        icon: "🩸" // Blood drop symbol, relevant to anemia.
    },
    Cardiology: {
        heading: "Cardiology",
        ...
        icon: "❤️" // Heart symbol, perfect for cardiology.
    },
    AntiDiabietic: {
        ...
        icon: "🍭" // Candy, as it often symbolizes blood sugar.
    },
    EyeHealth: {
        heading: "Eye Health",
        ...
        icon: "👁️" // Eye icon, directly representing eye health.
    },
    MemoryEnhancers: {
        ...
        icon: "🧠" // Brain icon, clearly linked to memory.
    },
    };

    return (
        <section className="cipla-visions foundation cus-bg-vision-grey">
            <div className="cipla-vision-wrapper">
                <div className="containerq">
                    <div className="view-header">
                        <h3>STANDING STRONG. CARING FOR LIFE.</h3>
                        <p>
                            The Company through the Foundation continues its passionate journey.
                        </p>
                    </div>
